...
golem::fill_desc(
  pkg_name = "dashboard.utilities", # The Name of the package containing the App 
  pkg_title = "Visualization utilities for bdvis Dashboard", # The Title of the package containing the App 
  pkg_description = "This Package contain various reactive and interactive visulaizations 
  which can be used later in other bdvis projects.", # The Description of the package containing the App 
